...
<template>
  ...
  <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10">
    <Trend color="green" title="Income" :amount="incomeTotal" :last-amount="prevExpenseTotal" :loading="pending"/>
    <Trend color="red" title="Expense" :amount="incomeTotal" :last-amount="prevExpenseTotal" :loading="pending"/>
